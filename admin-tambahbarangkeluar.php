      ...
      <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
          ...
          >
            ...
            <!-- Topbar Navbar -->
            <a class="nav-link d-flex align-items-center" href="admin-barangkeluar.php" >
                <i class="fas fa-fw fa-boxes" style="color:#6e707e"></i>
                <h1 class="h4 mb-0 text-gray-700 font-weight-bold" style="margin-left: 10px">Barang Keluar</h1>
            </a>
            <i class="fas fa-fw fa-chevron-right"></i>
            <a class="nav-link d-flex align-items-center" href="admin-tambahbarangkeluar.php" >
                <i class="fas fa-fw fa-plus mr-2" style="color:#6e707e"></i>
                <h1 class="h4 mb-0 text-gray-700 font-weight-bold" style="margin-left: 10px">Tambah Barang Keluar</h1>
            </a>
                ...
                <div class="table-responsive">
                  <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control shadow-sm" id="tanggal_keluar" name="tanggal_keluar" required>
                    </div>

                    <div class="form-group">
                        <label for="jumlah_barang">Jumlah Barang Keluar <i class="fas fa-star-of-life" style="font-size: 7px; vertical-align: top; color: #ED2939"></i></label>
                        ...
                        <script>
                          Swal.fire({
                            ...
                            icon: "success"
                             ...
                             window.location.href = 'admin-barangkeluar.php'; // Redirect after the user clicks "OK"
                           });
                        </script>
