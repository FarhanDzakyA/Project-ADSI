...
<?php 
    ...
    $query_old_id = mysqli_query($mysqli, "SELECT id_masuk FROM barang_masuk ORDER BY id_masuk DESC LIMIT 1");
    ...
    $newID = "IN-" . str_pad($numericPart, 4, "0", STR_PAD_LEFT);
?>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
          ...
          >
            ...
            <!-- Topbar Navbar -->
            <a class="nav-link d-flex align-items-center" href="admin-barangmasuk.php" >
                <i class="fas fa-fw fa-box-open" style="color:#6e707e"></i>
                <h1 class="h4 mb-0 text-gray-700 font-weight-bold" style="margin-left: 10px">Barang Masuk</h1>
            </a>
            <i class="fas fa-fw fa-chevron-right"></i>
            <a class="nav-link d-flex align-items-center" href="admin-tambahbarangmasuk.php" >
                <i class="fas fa-fw fa-plus mr-2" style="color:#6e707e"></i>
                <h1 class="h4 mb-0 text-gray-700 font-weight-bold" style="margin-left: 10px">Tambah Barang Masuk</h1>
            </a>
                ...
                <div class="table-responsive">
                  <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control shadow-sm" id="tanggal_masuk" name="tanggal_masuk" required>
                    </div>

                    <div class="form-group">
                        <label for="jumlah_barang">Jumlah Barang Masuk <i class="fas fa-star-of-life" style="font-size: 7px; vertical-align: top; color: #ED2939"></i></label>
                        <input type="text" class="form-control shadow-sm" id="jumlah_barang" name="jumlah_barang" required>
                    </div>
                    

                    <button type="submit" name="btn-simpan" class="btn btn-primary mt-4">Simpan</button>
                  </form>
                  ...
                  <?php
                    if(isset($_POST['btn-simpan'])) {
                      ...
                      $query_insert = mysqli_query($mysqli, "INSERT INTO `barang_masuk`(`id_masuk`, `id_barang`, `jumlah_barang`, `tanggal`) VALUES ('$id_masuk', '$barang','$jumlah_barang','$tanggal')");
